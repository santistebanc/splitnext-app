...
- `0009-symbols-tree.png` — Tree view from the entry points down: indentation rails, area tags on the row, the `N flows · N callers` pair, and stubs naming where their symbol expands.
