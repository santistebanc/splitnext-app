...
| `/group/[id]/member/[memberId]` | Member: URL wrapper for `L-memberDetail` (name + edit in the panel, **Close**); join link + copy/share if unclaimed; Remove member (confirm drawer) if unclaimed and not You; paid-for / owe-for / net / suggested settlement once the group has an expense; a bucket line opens that expense. Hub expands the same panel in place | slice 0023 / 0024 / 0025 / 0027 / 0028 / 0029 / 0033 / 0047 |
