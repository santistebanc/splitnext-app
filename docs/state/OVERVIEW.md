...
| `/group/[id]` | Hub: no stack header (Home + Settings on the canvas); group name as large centered type above the list; names until the first expense (rows expand member detail in place; no expense list link), then balances (You highlighted; tap expands member detail); add member + directly under the list; **Recent activity** (last three, relative times) above the expense CTAs once anything is recorded — **View all events** expands the full list here; top toast when sync brings someone else's activity; **View all expenses** expands the in-place expense list; settings gear expands the in-place settings panel; FAB expands `L-expenseForm` once bound; expense rows and settle prefill expand the same form; typed sync error; open → syncGroup | slice 0001–0007 / 0012 / 0017 / 0018 / 0019 / 0023 / 0027 / 0028 / 0034 / 0035 / 0036 / 0045 / 0046 / 0047 / 0048 / 0049 / 0050 |
| `/group/[id]/activity` | Full activity list with relative timestamps, newest first; **Undo** on this device's add/delete/kick lines. Hub opens this as an in-place expand; this route remains for the URL | slice 0034 / 0035 / 0036 / 0040 / 0046 |
