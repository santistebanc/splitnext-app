...
| L-expenses | All expenses | Screen | `app/group/[id]/expenses.tsx` | The group's expense list, pushed from the hub, newest first. A row opens that expense for edit. **Pending** while `L-expenseIsPending`. |
