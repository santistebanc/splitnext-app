...
| L-hubCorner | `HubCornerChrome` | Screen | `src/ui/HubCornerChrome.tsx` | Home (lobby) and Settings on the hub canvas, safe-area inset, no header bar. Settings expands `L-settingsPanel` on the hub. |
